...
fig = plt.figure()
# plt.plot(range(len(vy_accel)), vy_accel, c='r', label='Vel X IMU')
plt.plot(range(len(vel_y_imu)), vel_y_imu, c='r', label='Vel Y IMU')
...
plt.plot(range(len(accel_x)), accel_x, c='r', label='Accel X')
plt.plot(range(len(accel_y)), accel_y, c='g', label='Accel Y')
plt.xlabel('Amostras')
