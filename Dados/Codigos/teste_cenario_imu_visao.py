...
for i in range(10, 11, 1):
    ...
    for line in open(f"C:\\Users\\joaov\\Documents\\GitHub\\documents_msc\\Dados\\testes_mestrado\\teste_cenario_imu_visao_quad_menor\\teste_cenario_imu_visao_quad_menor\\ekf\\ekf_cenario_imu_visao_quad_menor_{i:02d}.txt", 'r'):
