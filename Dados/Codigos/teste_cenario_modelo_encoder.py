...
for i in range(1, 11, 1):
    ...
    for line in open(f"C:\\Users\\joaov\\Documents\\GitHub\\documents_msc\\Dados\\testes_mestrado\\teste_cenario_modelo_encoder_quad_maior\\teste_cenario_modelo_encoder_quad_maior\\visao\\visao_cenario_modelo_encoder_quad_maior_{i:02d}.txt", 'r'):
    ...
    for line in open(f"C:\\Users\\joaov\\Documents\\GitHub\\documents_msc\\Dados\\testes_mestrado\\teste_cenario_modelo_encoder_quad_maior\\teste_cenario_modelo_encoder_quad_maior\\ekf\\ekf_cenario_modelo_encoder_quad_maior_{i:02d}.txt", 'r'):
    ...
    for line in open(f"C:\\Users\\joaov\\Documents\\GitHub\\documents_msc\\Dados\\testes_mestrado\\teste_cenario_modelo_encoder_quad_maior\\teste_cenario_modelo_encoder_quad_maior\\laser\\laser_cenario_modelo_encoder_quad_maior_{i:02d}.txt", 'r'): 
    ...
    print(f"Mean error laser: {np.sqrt(np.mean(errors_laser)):.5f} m")
    print(f"Mean error x laser: {np.sqrt(np.mean(errors_x_laser)):.5f} m")
    print(f"Mean error y laser: {np.sqrt(np.mean(errors_y_laser)):.5f} m")
    print(f"Max error to laser: {np.sqrt(max(errors_laser)):.5f} m")
    print("##############################################")
    ...
    print(f"Mean error vision: {np.sqrt(np.mean(errors_vision)):.5f} m")
    print(f"Mean error x vision: {np.sqrt(np.mean(errors_x_vision)):.5f} m")
    print(f"Mean error y vision: {np.sqrt(np.mean(errors_y_vision)):.5f} m")
    print(f"Max error to vision: {np.sqrt(max(errors_vision)):.5f} m")
    print(f"Mean error theta: {np.sqrt(np.mean(errors_theta_vision)):.5f} degrees")
    print(f"Max error theta to vision: {np.sqrt(max(errors_theta_vision)):.5f} degrees")
