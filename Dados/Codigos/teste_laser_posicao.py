...
# plt.scatter(pos_x_ekf_sem_correcao, pos_y_ekf_sem_correcao, c='b', label='EKF sem correção')
# plt.xlabel("X (m)")
# plt.ylabel("Y (m)")
# plt.tight_layout()
...
for line in open('C:\\Users\\joaov\\Documents\\GitHub\\documents_msc\\Dados\\teste_integral\\ekf\\teste_2_dia_14.txt'):
    lines_ekf.append(line.rstrip().split(";"))
...
for line in open('C:\\Users\\joaov\\Documents\\GitHub\\documents_msc\\Dados\\teste_integral\\laser\\teste_2_dia_14.txt', 'r'): 
    lines_laser.append(line.rstrip().split(";"))
