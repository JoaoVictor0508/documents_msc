...
for i in range(1, 11, 1):
    ...
    for line in open(f"C:\\Users\\joaov\\Documents\\GitHub\\documents_msc\\Dados\\testes_mestrado\\teste_cenario_encoder_visao_quad_maior\\teste_cenario_encoder_visao_quad_maior\\visao\\visao_cenario_encoder_visao_quad_maior_{i:02d}.txt", 'r'):
    ...
    for line in open(f"C:\\Users\\joaov\\Documents\\GitHub\\documents_msc\\Dados\\testes_mestrado\\teste_cenario_encoder_visao_quad_maior\\teste_cenario_encoder_visao_quad_maior\\ekf\\ekf_cenario_encoder_visao_quad_maior_{i:02d}.txt", 'r'):
    ...
    for line in open(f"C:\\Users\\joaov\\Documents\\GitHub\\documents_msc\\Dados\\testes_mestrado\\teste_cenario_encoder_visao_quad_maior\\teste_cenario_encoder_visao_quad_maior\\laser\\laser_cenario_encoder_visao_quad_maior_{i:02d}.txt", 'r'): 
